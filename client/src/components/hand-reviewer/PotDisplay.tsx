...
export function PotDisplay(props: { pot: number; street: string; displayUnit: DisplayUnit; bigBlind: number }) {
  ...
  return (
    <div className="flex flex-col items-center gap-1.5 px-1 py-0">
      ...
      <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white/60">POT</p>
      <p className="text-base font-black text-amber-300">{formatValue(props.pot, props.displayUnit, props.bigBlind)}</p>
    </div>
  );
}
