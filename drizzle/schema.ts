...
export const playerPositionStats = mysqlTable("player_position_stats", {
  ...
  allInAdjBb100: int("allInAdjBb100").notNull().default(0),
  ...
  stealAttempt: int("stealAttempt").notNull().default(0),
  coldCall: int("coldCall").notNull().default(0),
  squeeze: int("squeeze").notNull().default(0),
  resteal: int("resteal").notNull().default(0),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
});
